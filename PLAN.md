...
## Архитектурное решение: стиль ≠ вариант

После анализа стилевых направлений выделили два независимых измерения:
...
2. **Тема** (цветовой стиль) — палитра, типографика, тени, кривые
   движения. Применяется через смену `data-theme` на корне,
